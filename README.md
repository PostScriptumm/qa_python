...
3. test_add_new_book_add_valid_name - проверка валидации добавления книг в словарь books_genre
...
4. test_add_new_book_add_no_valid_name – проверка валидации добавления книг в словарь books_genre
...
5. test_set_book_genre_set_genre_for_book – проверяем установку жанра для книги в словаре books_genre

6. test_set_book_genre_set_miss_genre – проверяем, что книге нельзя установить жанр, которого нет в списке genre

7. test_get_books_with_specific_genre_get_book_with_genre – проверяем возврат книг по жанру «Фантастика»

8. test_get_books_for_children_get_get_books_not_horror_and_detective – проверяем возврат книг из словаря books_genre без книг с жанрами находящимися в списке genre_age_rating

9. test_add_book_in_favorites_add_new_book_from_books_genre – проверяем добавление книг в список favorites
